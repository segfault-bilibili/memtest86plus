...
static int __attribute__((noclone)) own_addr_pattern_fill_check(int my_cpu, testword_t offset, bool check)
{
    int ticks = 0;
...
int test_own_addr1(int my_cpu, int stage)
{
    ...
    ticks += own_addr_pattern_fill_check(my_cpu, 0, !!stage);
...
int test_own_addr2(int my_cpu, int stage)
{
    ...
    ticks = own_addr_pattern_fill_check(my_cpu, offset, !!stage);
