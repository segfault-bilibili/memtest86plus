 ...
 */
#pragma GCC target ("mmx", "no-sse", "no-sse2", "no-avx")
static inline void write64_mmx_nt(const volatile uint64_t *ptr, uint64_t val)
{
    __m64 val2 = (__m64)val;
    __asm__ __volatile__(
        "movntq %1, %0"
 ...
 */
#pragma GCC target ("sse")
static inline void write128_sse_nt(const volatile __m128 *ptr, __m128 val)
{
    __asm__ __volatile__(
        "movntps %1, %0"
        :
 ...
 */
#pragma GCC target ("sse2")
static inline void write128_sse2_nt(const volatile __m128 *ptr, __m128 val)
{
    __asm__ __volatile__(
        "movntdq %1, %0"
        :
 ...
 */
#pragma GCC target ("avx")
static inline void write256_avx_nt(const volatile __m256 *ptr, __m256 val)
{
    __asm__ __volatile__(
        "vmovntdq %1, %0"
        :
